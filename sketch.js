...
function draw() {
  ...
  text("Highest Score "+sessionStorage["Highest Score"],200,50)
...
function createclouds() {
  if (frameCount % 80 === 0) {
    ...
    clouds.velocityX = -4;
    clouds.y = Math.round(random(60, 150));
